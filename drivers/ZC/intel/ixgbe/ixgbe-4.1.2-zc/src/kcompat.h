...
//TODO (replace line above if needed with this kcompat) #if ( LINUX_VERSION_CODE < KERNEL_VERSION(3,13,0) ) || defined(UBUNTU_3_13_PRE) /* HAVE_PF_RING patch (ubutu kernel >=3.13.0-30) */
...
#else /* >= 3.14.0 */
//TODO (replace line above if needed with this kcompat)
