...
#if !(UBUNTU_VERSION_CODE && UBUNTU_VERSION_CODE >= UBUNTU_VERSION(4,15,0,159) && UBUNTU_VERSION_CODE < UBUNTU_VERSION(5,0,0,0))
...
#undef CONFIG_PTP_1588_CLOCK /* Due to missing convert_art_to_tsc */
#endif
