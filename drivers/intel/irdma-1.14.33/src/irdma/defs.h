...
enum irdma_cqp_op_type {
	...
	IRDMA_OP_WS_MOVE			= 49,
	IRDMA_OP_SRQ_CREATE			= 52,
	IRDMA_OP_SRQ_MODIFY			= 53,
	IRDMA_OP_SRQ_DESTROY			= 54,
	/* Must be last entry */
	IRDMA_MAX_CQP_OPS			= 55,
};
...
#define IRDMA_CQPSQ_SRQ_SRQCTX_S 6
...
#define IRDMA_CQPSQ_STAG_PDID_HI_S 54
...
#define IRDMA_RING_CURRENT_TRUE_TAIL(_ring) ((_ring).true_tail)
...
#define IRDMA_RING_MOVE_TRUE_TAIL(_ring) \
	(_ring).true_tail = ((_ring).true_tail + 1) % (_ring).size

#define IRDMA_RING_SET_TRUE_TAIL(_ring, _pos) \
	(_ring).true_tail = (_pos) % (_ring).size
